...
def logsnr_cosine_interp_schedule(
    n, logsnr_min=-15, logsnr_max=15, scale_min=2, scale_max=4
):
...
def noise_schedule(
    schedule="logsnr_cosine_interp", n=1000, zero_terminal_snr=False, **kwargs
):
    # compute sigmas
    sigmas = {"logsnr_cosine_interp": logsnr_cosine_interp_schedule}[schedule](
        n, **kwargs
    )
